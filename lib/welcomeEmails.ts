...
const createTeacherNotificationTemplate = (data: {
  ...
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>${isCourseAssignment ? 'Asignación de Curso' : 'Promoción a Instructor'} - Maintech</title>
      <style>
        body { 
          font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; 
          line-height: 1.6; 
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>${isCourseAssignment ? '🎓 Asignación de Curso' : '⭐ Promoción a Instructor'}</h1>
        ...
        <div class="content">
          ...
          <div class="user-info">
            ...
            <div class="info-row">
              <span class="label">Estado:</span>
              <span class="value">✅ Rol actualizado</span>
            </div>
          </div>
        ...
        <div class="footer">
          <p>Este es un mensaje automático de notificación.</p>
          <p>Si tienes alguna pregunta, no dudes en <a href="mailto:soporte@maintech.com.pe">contactarnos</a>.</p>
          <p>© 2024 Maintech. Todos los derechos reservados.</p>
        </div>
      </div>
...
const createTeacherNotificationText = (data: {
  ...
  return `
${isCourseAssignment ? '🎓 Asignación de Curso' : '⭐ Promoción a Instructor'} - Maintech
...
export const sendTeacherNotificationEmail = async (teacherData: {
  ...
  try {
    ...
    // Crear contenido HTML y texto para notificación de instructor
